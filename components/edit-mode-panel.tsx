...
import { Settings, Users, Building, Printer, Save, X, Plus, Trash2 } from "lucide-react"
...
interface EditModePanelProps {
  ...
  onMoveEmployee: (employeeId: string, targetOffice: string) => void
...
export function EditModePanel({
  ...
  const handleMoveEmployee = (targetOffice: string) => {
    if (selectedEmployee) {
      onMoveEmployee(selectedEmployee.id, targetOffice)
    }
  }
              ...
              <div className="space-y-4">
                ...
                {editingEmployee ? (
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <Label>Move to Office</Label>
                      <Select onValueChange={handleMoveEmployee}>
                        <SelectTrigger>
